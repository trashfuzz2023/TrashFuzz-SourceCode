                        ...
                        if len(output_trace['trace']) > 1:
                            ...
                            if encoded_testcase.fitness <= 0.0:
                                ...
                                for spec in remaining_sub_violations:                                  
                                    ...
                                    if fitness0 >= 0.0:
                                        covered.append(spec)
                                        print("The spec been satisfied: "+str(spec))
                                        string_index2 = "The detailed fitness values:" + str(fitness0) + '\n'
                                        print(string_index2)                                           
                                    else:
                                ...
                                for itme in covered:
                                    ...
                                    del seed[itme]
                                    del mapping[itme]
                                string_index3 = "total coverage rate: {}/{} \n".format((maximun - len(remaining_sub_violations)), maximun)
                                print(string_index3)
                            # covered = []
                            else:
