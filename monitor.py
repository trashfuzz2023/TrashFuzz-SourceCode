...
if __name__ == "__main__":
    ...
    extracted_script = ExtractAll(input_file, True)
    ...
    with open(output_file) as f:
        ...
        single_spec = SingleAssertion(scenario_spec[scenario_name][0], "borregas_ave")
        print(single_spec.translated_statement)
        monitor = Monitor(data, single_spec)
        c = monitor.continuous_monitor2(single_spec.translated_statement)
        print(c) #总的robustness
        ...
        for spec in remaining_sub_violations:   
            ...
            print(spec)
            print("The "+ str(num)+ " : "+ str(fitness0)) #每个sub specification的
